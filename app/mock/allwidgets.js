...
//    });
    ...
    items.push({
        ...
        html: '<h2>Nicht in dieser Übersicht:</h2>'
            + '<ul>'
                + '<li>einige ux-Formelemente'
    ...
    var ghost = win.createGhost();
    if (ghost.dom.querySelector) {
        var hd = ghost.dom.querySelector('.x-window-header-text');
        hd.innerHTML = hd.innerHTML + ' (ghost)';
    }
    ...
    items.push({
        ...
        items: [{
            ...
            fieldLabel: 'CheckboxFieldset',
            xtype: 'CMScheckboxfieldset',
            title: 'Test'
        }, {
            fieldLabel: 'RadioFieldset',
            xtype: 'CMSradiofieldset',
            findParentBy: function () {
                return { id: Ext.id() };
            }
        }, {
            fieldLabel: 'SpliderField',
            xtype: 'CMSspliderfield',
            maxValue: 100
        }, {
    ...
    //document.body.style.background = 'url("data:image/gif;base64,R0lGODlhCAAIAKECAP///+Dg4DMzMzMzMyH5BAEKAAIALAAAAAAIAAgAQAINhBGpeY2r3FkNxnlNAQA7")';
});
