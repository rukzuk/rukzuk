...
<head>
    ...
    <title><%= i18n('html.pageTitle') %> - <%= i18n('error404.fileNotFound') %></title>
...
<div class="wrapper">
    ...
    <div id="error403" class="bigwarning">
        <p class="bigwarning-text"><i class="bigico warning"></i><%= i18n('error403.forbidden') %><br><br>
            <%= i18n('error403.forbiddenText') %><br><br>
            <a href="/"><%= i18n('error403.restartApp') %></a>
        </p>
    </div>
</div>
