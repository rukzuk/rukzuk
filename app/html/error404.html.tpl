...
<div class="wrapper">
    ...
    <div id="error404" class="bigwarning">
        <p class="bigwarning-text"><i class="bigico warning"></i><%= i18n('error404.fileNotFound') %><br><br>
            <%= i18n('error404.fileNotFoundText') %><br><br>
            <a href="/"><%= i18n('error404.restartApp') %></a>
        </p>
    </div>
</div>
