...
{
  protected $sqlFixtures = array('library_Cms_Dao_Website_Doctrine_CreateTest.json');
   ...
   * @group library
   */
  public function test_createShouldGenerateNewShortIdAsExpected()
  {
    // ARRANGE
    $existingShortId = 'create';
    ...
    $website = $daoMock->create(array('name' => 'PHPUnit Test: '.__CLASS__.'::'.__METHOD__));
