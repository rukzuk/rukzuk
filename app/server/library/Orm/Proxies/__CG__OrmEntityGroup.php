 ...
 */
class Group extends \Orm\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Orm\\Entity\\Group' . "\0" . 'id', '' . "\0" . 'Orm\\Entity\\Group' . "\0" . 'websiteid', '' . "\0" . 'Orm\\Entity\\Group' . "\0" . 'name', '' . "\0" . 'Orm\\Entity\\Group' . "\0" . 'rights', '' . "\0" . 'Orm\\Entity\\Group' . "\0" . 'users', '' . "\0" . 'Orm\\Entity\\Group' . "\0" . 'lastupdate');
        }
    ...
    public function setRights($rights)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRights', array($rights));
