 ...
 */
class OptIn extends \Orm\Entity\OptIn implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Orm\\Entity\\OptIn' . "\0" . 'userid', '' . "\0" . 'Orm\\Entity\\OptIn' . "\0" . 'code', '' . "\0" . 'Orm\\Entity\\OptIn' . "\0" . 'timestamp', '' . "\0" . 'Orm\\Entity\\OptIn' . "\0" . 'mode', '' . "\0" . 'Orm\\Entity\\OptIn' . "\0" . 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OptIn $proxy) {
