 ...
 */
class TemplateSnippet extends \Orm\Entity\TemplateSnippet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Orm\\Entity\\TemplateSnippet' . "\0" . 'id', '' . "\0" . 'Orm\\Entity\\TemplateSnippet' . "\0" . 'websiteid', '' . "\0" . 'Orm\\Entity\\TemplateSnippet' . "\0" . 'name', '' . "\0" . 'Orm\\Entity\\TemplateSnippet' . "\0" . 'description', '' . "\0" . 'Orm\\Entity\\TemplateSnippet' . "\0" . 'category', '' . "\0" . 'Orm\\Entity\\TemplateSnippet' . "\0" . 'content', '' . "\0" . 'Orm\\Entity\\TemplateSnippet' . "\0" . 'lastupdate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TemplateSnippet $proxy) {
