 ...
 */
class UserStatus extends \Orm\Entity\UserStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Orm\\Entity\\UserStatus' . "\0" . 'userid', '' . "\0" . 'Orm\\Entity\\UserStatus' . "\0" . 'authbackend', '' . "\0" . 'Orm\\Entity\\UserStatus' . "\0" . 'lastlogin');
        }
    ...
    public function getAuthbackend()
    {
        if ($this->__isInitialized__ === false) {
            return  parent::getAuthbackend();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAuthbackend', array());
    ...
    public function setAuthbackend($authbackend)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAuthbackend', array($authbackend));

        return parent::setAuthbackend($authbackend);
    }
