 ...
 */
class Album extends \Orm\Entity\Album implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Orm\\Entity\\Album' . "\0" . 'id', '' . "\0" . 'Orm\\Entity\\Album' . "\0" . 'websiteid', '' . "\0" . 'Orm\\Entity\\Album' . "\0" . 'name', '' . "\0" . 'Orm\\Entity\\Album' . "\0" . 'lastupdate');
        }
