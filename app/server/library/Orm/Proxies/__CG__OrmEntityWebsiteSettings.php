 ...
 */
class WebsiteSettings extends \Orm\Entity\WebsiteSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Orm\\Entity\\WebsiteSettings' . "\0" . 'id', '' . "\0" . 'Orm\\Entity\\WebsiteSettings' . "\0" . 'websiteid', '' . "\0" . 'Orm\\Entity\\WebsiteSettings' . "\0" . 'formValues', '' . "\0" . 'Orm\\Entity\\WebsiteSettings' . "\0" . 'lastupdate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WebsiteSettings $proxy) {
    ...
    public function setFormValues($formValues)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFormValues', array($formValues));

        return parent::setFormValues($formValues);
    }
    ...
    public function getFormValues()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFormValues', array());
