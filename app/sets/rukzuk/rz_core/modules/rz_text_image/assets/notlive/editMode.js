/* global define */
define(['jquery', 'CMS', 'rz_root/notlive/js/baseJsModule', 'rz_root/notlive/js/cssHelper', 'rz_text_image/notlive/jquery.mousewheel', 'rz_text_image/notlive/jquery.panzoom'], function ($, CMS, JsModule, cssHelper) {
    'user strict';
    ...
    var initializeModule = function (unitId) {
        ...
        if (cfg.formValues.imgsrc &&
            ...
            $('#' + unitId + ' > .imageContainer > .cropIcon')
    ...
    var closeImageCropper = function () {
        $('#' + imageCropperUnitId).find('.imageContainer').addClass('rzImageLoading');
    ...
    var startImageCropper = function (unitId) {
        ...
        var $unit = $('#' + unitId + ' > .imageContainer');
    ...
    var setVisualResize = function (unitId) {
        ...
        var startDrag = function () {
            triggerWidth = $wrapperElm.width() / 100;
    ...
    return JsModule.extend({
        ...
        onUnitDeselect: function (config) {
            ...
            $unit.find('> .imageContainer > .cropIcon').css('display', 'none');
        ...
        onFormValueChange: function (eventData) {
            ...
            if (eventData.key == 'imgsrc') {
                ...
                cssHelper.refreshCSS(eventData.unitId);
            }
        }
    });
});
