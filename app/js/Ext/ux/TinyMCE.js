...
//removed by Seitenbau: doesn't make sense to add the editor again?!
//The added reference won't be removed when the editor is removed...
            //tinyMCE.add(this.ed);

            // Fix editor size when control will be visible
            (function fixEditorSize() {

                // determine if element is visible (deep)
                var el = this.getVisibilityEl();
                var vis = this.rendered && el.isVisible(),
                    p   = el.dom.parentNode;
...
//added by Seitenbau: remove reference on TinyMCE instance
                this.ed = null;
            }
        ...
        */
        getRawValue: function () {
            ...
            if (!this.rendered || !this.ed || !this.ed.initialized)
...
//added by Seitenbau: allow other themes
/*
