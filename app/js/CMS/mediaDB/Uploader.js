...
/**
* @class CMS.mediaDB.Uploader
* @extends Ext.grid.GridPanel
*
* Upload panel with a grid and pluploader instance
*
*/
CMS.mediaDB.Uploader = Ext.extend(Ext.grid.GridPanel, {
    autoScroll: false,
    border: false,
    enableHdMenu: false,
    /**
    ...
    */
    ...
    initComponent: function () {
        ...
        CMS.mediaDB.Uploader.superclass.initComponent.apply(this, arguments);
    },
    ...
    destroy: function () {
        ...
        CMS.mediaDB.Uploader.superclass.destroy.apply(this, arguments);
    },
    ...
    */
    initUploader: function () {
        this.uploader = new plupload.Uploader({
            ...
            max_file_size: CMS.config.media.maxFileSize,
            flash_swf_url: CMS.config.urls.pluploadFlash,
            multi_selection: !this.singleFile,
            /*
            filters: [{
                title: CMS.i18n('Erlaubte Dateien: ') + CMS.config.uploadFileExtensions,
                extensions: CMS.config.uploadFileExtensions
            }],
            */
    ...
    */
    uploaderListeners: {
        ...
        FilesAdded: function (uploader, files) {
            ...
            //prevent adding the same file multiple times (see http://www.plupload.com/punbb/viewtopic.php?id=446)
            Ext.each(files, function (newFile) {
                Ext.each(uploader.files, function (existingFile) {
                    if (newFile.name == existingFile.name && newFile.size == existingFile.size) {
                        uploader.removeFile(newFile);
...
Ext.reg('CMSuploader', CMS.mediaDB.Uploader);
