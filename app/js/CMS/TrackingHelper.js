 ...
 * TrackingHelper
 */
CMS.TrackingHelper = Ext.extend(Object, {

    // switch production / staging segment.io write keys
    segmentKey: /rukzuk\.io$/.test(document.location.hostname) ? 'q9wcl9v3ki' : 'os9g7qcqrq',

    injectTracking: function () {
        // BEGIN segment.io tracking code
